...
export async function getNFTs(chainId: string | number) {
    const response = await axios.get(`https://thentic.tech/api/nfts?key=Y0U9geeoXrn2sv86Wr74a0AXAC8yONVm&chain_id=${chainId}`);
